...
namespace LoginWithAuthenticationTest.Controllers
{
    public class LanguagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LanguageID,Name,Image")] Language language)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LanguageID,Name,Image")] Language language)
        {
            if (ModelState.IsValid)
            {
